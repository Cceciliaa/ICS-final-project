...
# ==============================================================================
                ...
                message = msg["message"]
                self.indices[idx].add_msg_and_index("(" + from_name + ")" + ctime + " " + message) 
                ...
                for g in the_guys:
                    ...
                    # IMPLEMENTATION
                    # ---- start your code ---- #
                    self.indices[g].add_msg_and_index("(" + from_name + ")" + ctime + " " + message) 
                    mysend(
                        to_sock, json.dumps(
                        {"action": "exchange", "message": "["+idx+"]"+message}))
                    # ---- end of your code --- #
...
# ==============================================================================
                ...
                # ---- start your code ---- #
                from_name = self.logged_sock2name[from_sock]
                msg = "Here are all the users in the system:\n" + self.group.list_all(from_name)
...
# ==============================================================================
                ...
                search_rslt = ''
                from_name = self.logged_sock2name[from_sock]
                search = self.indices[from_name].search(msg["target"])
                
                for i in range(len(search)):
                    bgn = str(search[i]).find(",")
                    search_rslt += str(search[i])[bgn+1:-1] + "\n"
